...
namespace AnalizeHostingCompanies.Controllers.DbControllers
{
    public class LocationsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,City,DetailedAddress")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,City,DetailedAddress")] Location location)
        {
            if (ModelState.IsValid)
            {
